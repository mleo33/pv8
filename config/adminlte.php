...
return [
    ...
    */
    ...
    'title_prefix' => '',
    'title_postfix' => ' | ' . env('APP_INITIALS', 'POS'),
    ...
    */
    ...
    // [
        ...
        [
            'text' => 'Caja',
            'icon' => 'fas fa-fw fa-cash-register',
            'can' => ['realizar-corte', 'registrar-ingresos', 'registrar-egresos'],
            'submenu' => [
                [
                    'text'   => 'Conteo Físico',
                    'icon'   => 'fas fa-fw fa-chevron-right',
        ...
        [
            ...
            'submenu' => [
                ...
                [
                    'text'   => 'Clave de Productos',
                    'icon'   => 'fas fa-fw fa-chevron-right',
                    'route'  => 'productos.claves_productos',
                ],
                [
                    'text'   => 'Clave Unidades',
                    'icon'   => 'fas fa-fw fa-chevron-right',
                    'route'  => 'productos.claves_unidades',
                ]
            ]
        ],
        [
        ...
        //             'icon'   => 'fas fa-fw fa-chevron-right',
        //             'route'  => 'reportes.articulos_vendidos',
        //         ]
        //     ]
        // ],
        [
