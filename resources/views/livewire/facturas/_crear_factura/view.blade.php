...
<div class="p-3">
  ...
  @include('shared.rentas.modal_selection')
  ...
  @include('shared.productos.modal-selection', ['selectMode' => 1])
  @include('shared.equipos.modal-selection', ['validateAvailable' => false])
