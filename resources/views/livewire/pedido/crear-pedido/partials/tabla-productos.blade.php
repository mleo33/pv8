<div class="card">
  <div class="card-header">
    <h2 class="card-title font-weight-bold"><i class="fa fa-file-alt"></i> Realizar Pedido</h2>
  ...
  <div class="card-body p-0" style="min-height: 85vh">
    <table class="table table-hover">
      ...
      <tbody>
        @foreach ($pedido_t->conceptos as $item)
          <tr>
            ...
            <td>
              <input style="width: 100px; text-align: right;" wire:model.lazy="pedido_t.conceptos.{{$loop->index}}.precio" wire:change="priceChange({{$loop->index}})" onclick="this.select()" onkeypress="return event.charCode >= 46 && event.charCode <= 57"  type="text" class="form-control form-control-sm"/>
            </td>
