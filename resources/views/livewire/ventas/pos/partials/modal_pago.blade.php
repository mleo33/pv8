  ...
  <div class="modal-dialog modal-md">
      <div class="modal-content">
          <div class="modal-header">
              <h4 class="modal-title">Pagar @money($this->venta_t->PagoRequerido)</h4>
          ...
          <div class="modal-body">
              ...
              <center>
                  <?php
                    ...
                    $cambio = $montoTotal - $this->venta_t->PagoRequerido;
                    $mensaje = 'Faltan';
                    if($pagosCount == 1){
          ...
          <div class="modal-footer justify-content-between">
            ...
            @endphp
            <div wire:loading.remove wire:target="generarVenta">
                <button type="button" wire:click="generarVenta()" class="btn btn-{{$color}}" @if($disabled) disabled @endif><i class="fas {{$icon}}"></i> {{$txt}}</button>
            </div>
            <div wire:loading wire:target="generarVenta">
                <button type="button" wire:click="" class="btn btn-info" disabled><i class="fa fa-spin fa-spinner"></i> Procesando Pago...</button>
            </div>
          </div>
      </div>
  </div>
